          ...
          <div class="modal-body">
            <form action="partials/_handleSignup.php" method="post">
              ...
              <div class="text-left my-2">
                  ...
                  <input class="form-control" id="cpassword" name="cpassword" placeholder="Confirm Password" type="password" required data-toggle="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Your password must contain at least one number, one uppercase letter, and one special character, and should be more than 8 characters.">
              </div>
