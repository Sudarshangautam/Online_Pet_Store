...
<body>
    ...
    <div class="container my-4" id="cont" >
        <div class="row jumbotron" style="background-color:grey;" >
        <?php
        ...
        echo  '<div class="col-md-4">
            ...
            <div class="col-md-8 my-4" >
                <h3>' . $productName . ' </h3>
                <h5 style="color: #ffffff">Rs. '.$productPrice. '/-</h5>
                <p class="mb-0" style="color: #ffffff">' .$productDesc .'</p>';
                ...
                if($loggedin){
                    ...
                    if($quaExistRows == 0) {
                        echo '<form action="partials/_manageCart.php" method="POST">
                              ...
                              <button type="submit" name="addToCart" class="btn btn-primary my-2" style="background-color:#000000;color:ffffff;border-color:#ffffff">Add to Cart</button>';
                    }else {
                        echo '<a href="viewCart.php"><button class="btn btn-primary my-2" style="background-color:#000000;color:ffffff;border-color:#ffffff">Go to Cart</button></a>';
                    }
                }
                else{
                    echo '<button class="btn btn-primary my-2" data-toggle="modal" data-target="#loginModal" style="background-color:#000000;color:ffffff;border-color:#ffffff">Add to Cart</button>';
                }
                echo '</form>
