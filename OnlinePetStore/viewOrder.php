...
<body>
        ...
        <div class="table-wrapper" id="empty">
            <div class="table-title" style="text-align:center; background-color:black; color:white;">
                <!-- <div class="row" style="align-items:center;">
                    <div class="col-sm-4" > -->
                        <h2 style="text-align:center;">Order <b>Details</b></h2>
                    </div>
                    <!-- <div class="col-sm-8">						
            ...
            <table class="table table-striped table-hover text-center">
                ...
                <tbody>
                    <?php
                        ...
                        if($counter==0) {
                            ?><script> document.getElementById("empty").innerHTML = '<div class="col-md-12 my-5" style="background-color:black;"><div class="card" style="background-color:grey;"><div class="card-body cart"><div class="col-sm-12 empty-cart-cls text-center"> <img src="Images/cart.jpg" width="130" height="130" class="img-fluid mb-4 mr-3"><h3 style="color:#ffffff;"><strong>You have not order anything.  Please make the orders to see items.</strong></h3> <a href="index.php" class="btn btn-primary cart-btn-transform m-3" data-abc="true" style="background-color: black; color:#ffffff; border-color:#ffffff;">continue shopping</a> </div></div></div></div>';</script> <?php
                        }
                    ?>
                </tbody>
            </table>
    ...
    <?php 
        ...
        <div class="alert alert-info my-3" style="background-color:#000000; color:#ffffff;">
            <font style="font-size:27px"><center>Please login first to see yours orders!!!! <strong><a class="alert-link" data-toggle="modal" data-target="#loginModal"  style="background-color:#ffffff; color:#000000;">Login Here</a></strong></center></font>
        </div></div>';
    }
    ?>
