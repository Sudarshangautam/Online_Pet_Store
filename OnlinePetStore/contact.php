...
<html lang="en">
  ...
  <?php include 'partials/_nav.php';?>
      ...
      <div class="contact2" style="background-image:url(Images/img5.jpg);height: 700px;" id="contact">
        <div class="container">
            ...
            <div class="col-lg-12">
              <div class="card card-shadow border-0 mb-4">
                <div class="row">
                    ...
                    <div class="contact-box p-4">
                        ...
                        <?php if($loggedin){ ?>
                          <div class="col-lg-4">
                            <div class="icon-badge-container mx-1" style="padding-left: 167px;">
                              ...
                              <button type="button" style=" background-color:black; color:white; border-color:#ffffff;" data-toggle="modal" data-target="#adminReply"><span>Admin Reply <i class="ti-arrow-right"></i></span></button>
                      ...
                      <form action="partials/_manageContactUs.php" method="POST">
                        <div class="row">
                          ...
                          <?php if($loggedin){ ?>
                            <div class="col-lg-12">
                              <button type="submit"  style=" background-color:black; color:white; border-color:#ffffff;"><span > SUBMIT NOW <i class="ti-arrow-right"></i></span></button>
                              <button type="button" style=" background-color:black; color:white; border-color:#ffffff;" data-toggle="modal" data-target="#history"><span> View Your Message <i class="ti-arrow-right"></i></span></button>
                            </div>
                          <?php }else { ?>
                            <div class="col-lg-12">
                              <button type="submit" style=" background-color:black; color:white; border-color:#ffffff;" disabled><span> SUBMIT NOW <i class="ti-arrow-right"></i></span></button>
                  ...
                  <?php
                    echo '<div class="col-lg-4 bg-image" style="background-image:url(Images/img4.jpg)">
                   </div>';
                  ?>
                </div>
              </div>
      ...
      <div class="modal fade" id="adminReply" tabindex="-1" role="dialog" aria-labelledby="adminReply" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header"  style="background-color:#000000; color:#ffffff; border-color:#000000;">
              <h5 class="modal-title" id="adminReply" style="margin-left:40%;">Admin Reply</h5>
