            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="card" style="width: 18rem;">
                            <img src="img/product-'.$productId. '.jpg" class="card-img-top" alt="image for this product" width="249px" height="270px" style="margin-top:0px; margin-left:0px;">
                            ...
                            echo '</form>                            
                                <a href="viewProduct.php?productid=' . $productId . '" name="view" id="view" class="mx-2"><button class="btn btn-primary" style="background-color:#000000; color:#ffffff; border-color:#ffffff;">Quick View</button></a> 
                                </div>
                            </div>
                        </div>
                    </div>';
